...
const emptyProject: Project = { id: Date.now(), title: '', category: ProjectCategory.Design, description: '', imageUrl: '', tags: [], liveUrl: '', sourceUrl: '' };
        ...
        <div className={modalOverlayStyle} onClick={onClose}>
            <div className={modalContentStyle} onClick={e => e.stopPropagation()}>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div><label>Description</label><textarea name="description" value={formData.description} onChange={handleChange} rows={3} className={inputStyle}></textarea></div>
                    <div><label>Image URL</label><input name="imageUrl" value={formData.imageUrl} onChange={handleChange} className={inputStyle} /></div>
